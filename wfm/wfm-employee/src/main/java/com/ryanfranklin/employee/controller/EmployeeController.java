...
class EmployeeController {
	...
	@Autowired
	private EmployeeController(EmployeeService employeeService, EmployeeRepository employeeRepository) {
		super();
	...
	public ResponseEntity<Employee> put(@PathVariable long id, @RequestBody @Valid Employee employee) {
